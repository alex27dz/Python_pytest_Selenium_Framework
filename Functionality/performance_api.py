...
# Latency
def api_01_response_delete_online_offering_98391():
...
def api_02_response_update_online_offering_98387():
    ...
    print('Average response time ', average_response_time)
    print('Maximum response time ', max_response_time)
def api_04_response_add_online_offering_98383():
    ...
    print('Average response time ', average_response_time)
    print('Maximum response time ', max_response_time)
def api_05_response_delete_class_offering_98377():
    ...
    print('Average response time ', average_response_time)
    print('Maximum response time ', max_response_time)
def api_06_response_update_class_offering_98372():
    ...
    print('Average response time ', average_response_time)
    print('Maximum response time ', max_response_time)
def api_07_response_add_class_offering_98194():
    ...
    print('Average response time ', average_response_time)
    print('Maximum response time ', max_response_time)
def api_08_response_add_learning_record_98393():
